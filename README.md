...
See the dedicated [environment setup file](env_setup.md).
 ...
 * `project_OPERA.ipynb`[notebooks/project_OPERA.ipynb]
 * `project_Ornish.ipynb`[notebooks/project_Ornish.ipynb]
 * `project_Xsurv.ipynb`[notebooks/project_Xsurv.ipynb]
